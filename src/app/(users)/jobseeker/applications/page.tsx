...
import { useGetJobApplicationsByJobSeekerId } from "../../../../hooks/useJobApplications";

const ApplicationsPage = () => {
	const [selectedStatus, setSelectedStatus] = useState("all");
	const jobSeekerId = getItem("user_id");
	const router = useRouter();
	const {
		data: jobApplications,
		isLoading,
		error,
	} = useGetJobApplicationsByJobSeekerId(jobSeekerId);
				...
				<div className="space-y-4">
					{filteredApplications.map((application) => (
						<div
							...
							onClick={() =>
								router.push(
									`/jobseeker/applications/${application.jobPostingId}`
								)
							}
						>
