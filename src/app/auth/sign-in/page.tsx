...
const SignIn = () => {
    return (
        <div className='w-[100vw] h-[100vh] flex items-center justify-center'>
            <Card
                className='w-[450px] h-[480px] shadow-xl'
            >
                <h1 className='text-center text-3xl font-bold'>Welcome Back</h1>
                <h2 className='text-center text-[15px] text-gray-500 mt-2'>Sign in to your account</h2>
                <Form
                    name="basic"
                    layout='vertical'
                    labelCol={{ span: 24 }}
                ...
                >
                    ...
                    <div className="">
                        <p className='text-center'>Don`t have an account? <Link href="/auth/sign-up">Register</Link></p>
                    </div>
                </Form>
            </Card>
        </div>
