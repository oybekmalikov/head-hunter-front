'use client';
import { Bell, ChevronDown, CircleUser, FileText, LogOut, User } from 'lucide-react';
				...
				<div className='flex items-center justify-between'>
					...
					<div className='flex items-center gap-6'>
						<div className='hidden md:flex items-center gap-1 bg-gray-100 rounded-2xl p-2'>
							<button
								onClick={() => router.push(`/employer/job-seekers`)}
								className={`px-6 py-3 rounded-xl font-semibold transition-all
									${
										pathname === `/${role}/job-seekers`
							...
							<button
								onClick={() => router.push(`/employer/chats`)}
								className={`px-6 py-3 rounded-xl font-semibold transition-all ${
									pathname === `/${role}/chats`
										? 'bg-white text-blue-600 shadow-lg'
										: 'text-gray-600 hover:text-gray-900'
